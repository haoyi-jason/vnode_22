...
#define USER_FLASH_BASE 0x08006000  // 32K, page 16 or 32

#if defined(AT32F413Rx_HD)
#define PAGE_SIZE               (uint16_t)0x800         // 2k page size
#define FLASH_START_ADDRESS     ((uint32_t)0x8005000)   // EEPROM start address
...
#define FLASH_START_ADDRESS     ((uint32_t)0x8005000) // page 30*1K
#define FLASH_BASE_ADDRESS      ((uint32_t)0x8000000)
...
#define BL_CONFIG_ADDRESS       0x08005800      // bootloader option
